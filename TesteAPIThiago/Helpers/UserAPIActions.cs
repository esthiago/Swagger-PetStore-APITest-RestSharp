...
namespace TesteAPIThiago.Helpers
{
    class UserAPIActions
    {
        ...
        public Get_Username_Response Get_Username(string username)
        {
            ...
            {
                LoggerOutput.WriteLine("Erro, esperava code: " +System.Net.HttpStatusCode.OK +" mas, foi retornado: " +restResponse.StatusCode);
                return null;
            }
        }
        ...
        public Generic_Response Get_login(string username, string password)
        {
            ...
            if (restResponse.StatusCode == System.Net.HttpStatusCode.OK)
            {
                return JsonSerializer.Deserialize<Generic_Response>(restResponse.Content); //Generic error response possui os atributos {code, type e message}
            }
            else
            {
                return null;
